...
include_once $this->targetDirs[3].'/src/DataFixtures/PrestaFixtures.php';

$this->privates['doctrine.fixtures.loader'] = $instance = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);

$instance->addFixtures([0 => ['fixture' => ($this->privates['App\\DataFixtures\\AppFixtures'] ?? ($this->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []], 1 => ['fixture' => ($this->privates['App\\DataFixtures\\PrestaFixtures'] ?? ($this->privates['App\\DataFixtures\\PrestaFixtures'] = new \App\DataFixtures\PrestaFixtures())), 'groups' => []], 2 => ['fixture' => ($this->privates['App\\DataFixtures\\SystemUserFixtures'] ?? $this->load('getSystemUserFixturesService.php')), 'groups' => []]]);
