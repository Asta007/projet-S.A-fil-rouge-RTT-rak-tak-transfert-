...
// Returns the private 'App\Repository\CrudSupportRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CrudSupportRepository.php';

return $this->privates['App\\Repository\\CrudSupportRepository'] = new \App\Repository\CrudSupportRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
