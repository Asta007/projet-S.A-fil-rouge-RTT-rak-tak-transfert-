...
// Returns the private 'App\Repository\PrestatairesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PrestatairesRepository.php';

return $this->privates['App\\Repository\\PrestatairesRepository'] = new \App\Repository\PrestatairesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
