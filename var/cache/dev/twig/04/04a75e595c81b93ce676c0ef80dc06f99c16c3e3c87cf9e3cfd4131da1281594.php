...
class __TwigTemplate_8cdad31084c3185e0e7034ab97dabd4a1962be8d73f04b1dd3f20816fb550bda extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["compte"]) || array_key_exists("compte", $context) ? $context["compte"] : (function () { throw new RuntimeError('Variable "compte" does not exist.', 16, $this->source); })()), "intitule", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Solde</th>
...
{% endblock %}
", "compte/show.html.twig", "/var/www/html/my symphon/Fil_touge_RTT/templates/compte/show.html.twig");
    }
}
