...
// Returns the private 'App\Repository\SystemUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SystemUserRepository.php';

return $this->privates['App\\Repository\\SystemUserRepository'] = new \App\Repository\SystemUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
